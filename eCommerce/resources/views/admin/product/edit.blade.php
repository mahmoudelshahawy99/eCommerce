            ...
            <form action="{{ url('update-product/'.$product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="meta_descrip" class="form-control" rows="3">{{ $product->meta_descrip }}</textarea>
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    @if($product->image)
                        <img src="{{ asset('assets/uploads/product/'.$product->image) }}" class="cat-img" alt="Product image">
                    @endif
                    <div class="col-md-12">
