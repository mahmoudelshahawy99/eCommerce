...
class ReviewController extends Controller
{
    public function addReview($product_slug){
        ...
        if($product){
            ...
            if($review){
                ...
                return view('frontend.reviews.index', compact('verfied_purchase', 'product'));
            }
        }else{
    ...
    public function insertReview(Request $request){
        ...
        if($product){
            ...
            if($new_review){
                return redirect('category/'.$cat_slug.'/'.$prod_slug)->with('status', 'Thanks for your review');
            }
        }else{
            return redirect()->back()->with('status', 'The link was broken');
        }
    ...
    public function updatetReview(Request $request){
        $user_review = $request->input('user_review');
        if($user_review != ''){
            ...
            return redirect()->back()->with('status', 'You can not submit a review');
        }
    }
}
